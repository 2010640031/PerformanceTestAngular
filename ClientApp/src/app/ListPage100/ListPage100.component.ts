...
@Component({
  selector: 'app-ListPage100',
  templateUrl: './ListPage100.component.html',
})
export class ListPage100Component implements OnInit {
  cars: Car[] = [];
  allColorsSet = false;
  ...
  ngOnInit() {
    this.cars = this.carService.getCars(100);
  }
