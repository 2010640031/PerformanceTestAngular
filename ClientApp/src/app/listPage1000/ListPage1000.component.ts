...
@Component({
  selector: 'app-ListPage1000',
  templateUrl: './ListPage1000.component.html',
})
export class ListPage1000Component implements OnInit {
  cars: Car[] = [];
  allColorsSet = false;
  ...
  ngOnInit() {
    this.cars = this.carService.getCars(1000);
  }
